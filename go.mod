...
replace (
	// these replacements are pinned to 2e7996e3e271 which is the sha associated with the 0.18.3 tag on k/k
	// as you cannot pin them to v0.18.3 directly
	...
	k8s.io/node-api => k8s.io/kubernetes/staging/src/k8s.io/node-api v0.0.0-20200520124240-2e7996e3e271
