...
replace (
	// these replacements are pinned to dff82dc0de47 which is the sha associated with the 0.18.6 tag on k/k
	// as you cannot pin them to v0.18.6 directly
	...
	k8s.io/node-api => k8s.io/kubernetes/staging/src/k8s.io/node-api v0.0.0-20200715165012-dff82dc0de47
